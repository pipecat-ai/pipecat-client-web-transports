...
export class OpenAIRealTimeWebRTCTransport extends Transport {
  ...
  static create(opts: OpenAIServiceOptions): OpenAIRealTimeWebRTCTransport {
    return new OpenAIRealTimeWebRTCTransport(opts);
  }
      ...
      case RTVIMessageType.APPEND_TO_CONTEXT:
        {
          ...
          const runImmediately = data.runImmediately ?? false;
